...
IUSE="+bluetooth +colord +cups doc elogind flickr +gnome-online-accounts +ibus input_devices_wacom kerberos libinput networkmanager +share systemd test thunderbolt v4l wayland"
REQUIRED_USE="
	?? ( elogind systemd )
