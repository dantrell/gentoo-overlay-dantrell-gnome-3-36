...
IUSE="anjuta +bijiben boxes builder california +celluloid +dino empathy epiphany +evolution flashback +foliate +fonts +games gconf geary +ghex gnote gpaste latexila multiwriter +polari +recipes +share +shotwell simple-scan software +todo +tracker +usage"
...
RDEPEND="
	...
	tracker? (
		...
		>=gnome-extra/gnome-books-3.34.0
